Shader "Toony Colors Pro 2/Examples/Cat Demo/Cat/Style 1" {
	Properties {
		...
		_ColorMaskStrength ("Masked Color Strength", Range(0, 4)) = 1
		[Space] _HColor ("Highlight Color", Vector) = (0.785,0.785,0.785,1)
		_SColor ("Shadow Color", Vector) = (0.195,0.195,0.195,1)
		[Header(Shadow HSV)] _Shadow_HSV_H ("Hue", Range(-360, 360)) = 0
		_Shadow_HSV_S ("Saturation", Range(-1, 1)) = 0
		_Shadow_HSV_V ("Value", Range(-1, 1)) = 0
		[TCP2Separator] _MainTex ("Main Texture", 2D) = "white" {}
